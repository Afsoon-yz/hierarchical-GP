...
#define fitness_stall			0.01
#define crossover_rate			0.2
#define max_nondominated		2600	
...
void main(int argc , char *argv[])
{
	...
	strcpy(accuracy_file , "NH/a3r");
	strcpy(cost_file	 , "NH/c3r");
	strcpy(usage_file	 , "NH/u3r");
	strcpy(nondom_file	 , "NH/n3r");
